        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            ...
            <div className='flex justify-center px-4 py-14'>
                ...
                >
                    ...
                    <p className='pb-5'>Copy and paste the following code in your website codebase to embed the chatbot</p>
                    ...
                    <ol className='space-y-3 text-sm text-zinc-600 list-decimal list-inside'>
                        ...
                        <li>Save your changes and refresh your website to see the chatbot</li>
                    </ol>
                        ...
                        <div className='rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden'>
                            ...
                            <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                                ...
                                <motion.div
                                    ...
                                    className='absolute bottom-6 right-6 w-14 h-14 bg-black rounded-full text-white flex items-center justify-center shadow-2xl cursor-pointer'
                                >
                                    🗨️
                                </motion.div>
                            </div>
